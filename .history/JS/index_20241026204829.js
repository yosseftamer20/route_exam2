...
function displaySearchInputs() {
    ...
    <div class="row py-4">
            <div class="col-md-6">
                <input onkeyup="searchByName(this.value)" class="form-control bg-transparent text-light" type="text" id="searchByName" placeholder="Search By Name">
            </div>
            <div class="col-md-6">
...
async function getSearchByNmae() {
...
function displaySearchByNmae(arr) {
    let box = "";
