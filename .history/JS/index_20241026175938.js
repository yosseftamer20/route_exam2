    ...
    box += `
        <div class="col-md-4">
            ...
            <div class="col-md-8">
                ...
                <h3>
                    Area :<span class="fw-bolder">${details.}</span>
                </h3>
                <h3>
                    Category :<span class="fw-bolder">${details.}</span>
                </h3>
                <h3>Recipes :</h3>

                <ul id="recipes" class="list-unstyled d-flex flex-wrap g-3">
                    <li class="alert alert-info m-2 p-1">`${ } ` `${ } `</li>
                </ul>
                <h3>Tags :</h3>
                <ul class="list-unstyled d-flex g-3 flex-wrap">
                    <li class="alert alert-danger m-2 p-1">${}</li>
                </ul>
                <a target="_blank" href="${details.}" class="btn btn-success">Source</a>
                <a target="_blank" href="${details.}" class="btn btn-danger">Youtube</a>
            </div>
        `
    displayArea.innerHTML = box;
}
