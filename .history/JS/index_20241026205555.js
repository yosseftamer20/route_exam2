...
function displayIngredients(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
        box += `
        <div class="col-md-3">
                <div  class="rounded-2 text-center cursor">
...
function displaySearchInputs() {
    ...
    <div class="row py-4">
            <div class="col-md-6">
                <input onkeyup="getSearchByNmae(this.value)" class="form-control bg-transparent text-light" type="text" id="searchByName" placeholder="Search By Name">
            </div>
            <div class="col-md-6">
                <input onkeyup="searchByName(this.value)" class="form-control bg-transparent text-white" maxlength="1" type="text" id="searchByFL" placeholder="Search By First Letter">
            </div>
        </div>
    `
    disPlayArea.innerHTML = searchContainer;

}


async function getSearchByNmae(mealName) {
...
async function getSearchBy[(mealName) {
