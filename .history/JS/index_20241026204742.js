...
function displaySearchInputs() {
    ...
    <div class="row py-4">
            <div class="col-md-6">
                <input class="form-control bg-transparent text-light" type="text" id="searchByName" placeholder="Search By Name">
            </div>
            <div class="col-md-6">
                <input class="form-control bg-transparent text-white" maxlength="1" type="text" id="searchByFL" placeholder="Search By First Letter">
            </div>
        </div>
    `
