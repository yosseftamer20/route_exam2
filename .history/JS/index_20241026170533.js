...
function displayMeals(arr) {
    ...
    arr.forEach(meal => {
        box += `
        <div class="col-md-3">
                <div onclick="displayMealDetails('${meal.idMeal}')" class="meal cursor position-relative overflow-hidden rounded-2">
...
async function getMealDetails(mealID) {
    ...
    displayArea.innerHTML = '';
    let response = await fetch(`https://www.themealdb.com/api/json/v1/1/lookup.php?i=${area}`)
    response = await response.json()
